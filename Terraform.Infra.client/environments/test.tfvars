...
tags            = {"Source"  = "Terraform", "Contact" = "jci-ds-support@jci.com", "Env" = "test", "Owner" = "JCI", "Product" = "UOC", "Release_Manifest" = "R2.3.0"}
...
ar_sop_service_new_url = ""
obt_graphql_url = "https://openblue-test.hostcountry.qa/v1/graphql"
ob_consumer_group = "obuoc-eventproc"
ob_eventhub = "evh-obuoc-obtevents-test-unistad-we1"
audiences = "https://obuoc-test.hostcountry.qa/api"
...
azurerm_kusto_cluster_name= "adxobuoctest"
adx_sku_name_size = "Standard_D13_v2"
azurerm_kusto_database_name = "adx-db-obuoc-test-unistad-001"
